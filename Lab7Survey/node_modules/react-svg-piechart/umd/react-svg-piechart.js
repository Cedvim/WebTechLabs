/*!
 * react-svg-piechart v2.0.2 - https://github.com/xuopled/react-svg-piechart#readme
 * MIT Licensed
 */
...
var PieChart = function (_React$Component) {
  ...
  function PieChart() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.state = { expandedIndex: null }, _this.handleSectorHover = function (data, index, e) {
  ...
  PieChart.prototype.render = function render() {
    ...
    var dataCount = data.reduce(function (count, d) {
      return d.value > 0 ? count + 1 : count;
    }, 0);
    return data && dataCount > 0 ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      "svg",
      {
      ...
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        ...
        data.length === 1 || dataCount === 1 ? this.renderSingleData(data[0], center) : this.renderMultipleData(center)
      )
    ) : null;
  };
...
var Sectors = function Sectors(_ref) {
  ...
  var total = Math.ceil(data.reduce(function (prev, current) {
